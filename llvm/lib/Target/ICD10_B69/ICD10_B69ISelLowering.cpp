...
#include "ICD10_B69.h"
#include "ICD10_B69MachineFunctionInfo.h"
...
static const MCPhysReg ArgGPRs[] = {ICD10_B69::R9, ICD10_B69::R10, ICD10_B69::R11, ICD10_B69::R12};

void ICD10_B69TargetLowering::ReplaceNodeResults(SDNode *N,
...
#include "ICD10_B69GenCallingConv.inc"
...
SDValue ICD10_B69TargetLowering::LowerCall(TargetLowering::CallLoweringInfo &CLI,
  ...
  CCInfo.AnalyzeCallOperands(Outs, CC_ICD10_B69);
  ...
  for (unsigned i = 0, j = 0, e = ArgLocs.size(); i != e; ++i) {
    ...
    if (VA.isRegLoc()) {
      ...
      if (!StackPtr.getNode())
        StackPtr = DAG.getCopyFromReg(Chain, DL, ICD10_B69::R1, PtrVT);
      SDValue Address =
  ...
  Chain = DAG.getNode(ICD10_B69ISD::CALL, DL, NodeTys, Ops);
  ...
  RetCCInfo.AnalyzeCallResult(Ins, RetCC_ICD10_B69);
...
static SDValue convertValVTToLocVT(SelectionDAG &DAG, SDValue Val,
                                   ...
                                   const ICD10_B69Subtarget &Subtarget) {
...
static SDValue unpackFromRegLoc(SelectionDAG &DAG, SDValue Chain,
                                const CCValAssign &VA, const SDLoc &DL,
                                const ICD10_B69TargetLowering &TLI) {
  MachineFunction &MF = DAG.getMachineFunction();
...
/// ICD10_B69 formal arguments implementation
SDValue ICD10_B69TargetLowering::LowerFormalArguments(
  ...
  SmallVector<CCValAssign, 16> ArgLocs;
  CCState CCInfo(CallConv, IsVarArg, MF, ArgLocs, *DAG.getContext());
  CCInfo.AnalyzeFormalArguments(Ins, CC_ICD10_B69);
  ...
  if (IsVarArg) {
    ...
    const TargetRegisterClass *RC = &ICD10_B69::GPRRegClass;
    MachineFrameInfo &MFI = MF.getFrameInfo();
    MachineRegisterInfo &RegInfo = MF.getRegInfo();
    ICD10_B69FunctionInfo *UFI = MF.getInfo<ICD10_B69FunctionInfo>();
...
bool ICD10_B69TargetLowering::CanLowerReturn(
  ...
  if (!CCInfo.CheckReturn(Outs, RetCC_ICD10_B69))
    return false;
...
SDValue
ICD10_B69TargetLowering::LowerReturn(SDValue Chain, CallingConv::ID CallConv,
                               bool IsVarArg,
  ...
  const ICD10_B69Subtarget &STI = MF.getSubtarget<ICD10_B69Subtarget>();
  ...
  CCInfo.AnalyzeReturn(Outs, RetCC_ICD10_B69);
  ...
  return DAG.getNode(ICD10_B69ISD::RET, DL, MVT::Other, RetOps);
}
...
SDValue ICD10_B69TargetLowering::PerformDAGCombine(SDNode *N,
...
bool ICD10_B69TargetLowering::isLegalAddressingMode(const DataLayout &DL,
